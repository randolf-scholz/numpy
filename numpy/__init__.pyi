...
_TD64ItemT_co = TypeVar("_TD64ItemT_co", bound=dt.timedelta | int | None, covariant=True)
_DT64ItemT_co = TypeVar("_DT64ItemT_co", bound=dt.date | int | None, covariant=True)
